...
similar projects. I also think terminal interfaces look cool.
...
```
NEXT_PUBLIC_HOSTNAME='localhost'   // The default base URL for containers with defined ports.
NEXT_PUBLIC_THEME_DEFAULT='random' // The name of a valid color theme, or `random` for a random theme.
NEXT_PUBLIC_TITLE='BSHDRD'         // The server name used in the page title and MOTD.
```
